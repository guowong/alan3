/*
 MaxPlayers - determine if there are not enough, too many or just the right number of platers on a team
 Alan Wong
...
public class JavaPlayersOnTeam {
	...
	public static void main(String[] args) {
		...
		if (playersOnTeam < 0)
		{
			System.out.println ("You cannot have a negative amount of players");
		}
		else
		{		
			// Process and output		
	...
	static int SelectTeamSize()
	{
		...
		int teamSize; // return # of players that should be on a team
